...
<head>
    ...
    <title>sᴀᴍᴇᴇʀ ᴛʜᴇ ʀᴇᴀʟ ʜᴀᴄᴋᴠɪsᴛ </title>
    <style>
        * {
            margin: 0;
            padding: 0;
